            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-6 sm:pt-8">
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm text-white font-medium">{t('stats.projects')}</div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm text-white font-medium">{t('stats.internships')}</div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="cyber-card rounded-lg p-3 sm:p-4 text-center cursor-default"
                >
                  <div className="text-lg sm:text-2xl font-bold text-cyber-primary mb-1">{t('stats.languages')}</div>
                  <div className="text-[10px] sm:text-xs text-white font-medium leading-tight">{t('stats.languagesValue')}</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
