      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-3 sm:space-y-4 md:space-y-0 text-center md:text-left">
          ...
          <div className="flex items-center space-x-2 text-gray-400 text-xs sm:text-sm">
            ...
            <Heart className="text-cyber-accent hidden sm:inline" size={14} fill="currentColor" />
          </div>
        ...
        {/* Decorative line */}
        <div className="mt-4 sm:mt-6 h-1 bg-gradient-to-r from-transparent via-cyber-primary to-transparent opacity-30" />
      </div>
    </footer>
  );
}